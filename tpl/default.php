			...
			<div class="row">
				<div class="col-lg-12">
					<nav class="navbar navbar-expand-lg navbar-light px-0">
						<a class="navbar-brand" href="index-7.html#"><img src="{{_var.base}}/images/logo/logo-white.png" alt="logo"></a>
							...
							<ul class="navbar-nav mx-auto">
								<li class="nav-item dropdown">
									...
									<ul class="dropdown-menu"> 
										...
										<li><a class="dropdown-item" href="index-7.html">Home Seven</a></li>
										<li><a class="dropdown-item" href="index-8.html">Home Eight</a></li>
										<li><a class="dropdown-item" href="index-9.html">Home Nine</a></li>
										<li><a class="dropdown-item" href="index-10.html">Home Ten</a></li> 
										<li><a class="dropdown-item" href="index-11.html">Home Eleven</a></li> 
										<li><a class="dropdown-item" href="index-12.html">Home Twelve</a></li>
										<li><a class="dropdown-item" href="index-13.html">Home Thirteen</a></li>
										<li><a class="dropdown-item" href="index-14.html">Home Fourteen</a></li>
										<li><a class="dropdown-item" href="index-15.html">Home Fifteen</a></li>
										<li><a class="dropdown-item" href="index-16.html">Home Sixteen</a></li>
									</ul>
								</li>
								<li class="nav-item dropdown">
									<a class="nav-link dropdown-toggle" href="index-7.html#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Listing</a>
								...
								<li class="nav-item dropdown">
									<a class="nav-link dropdown-toggle" href="index-7.html#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Agents</a>
									<ul class="dropdown-menu shadow">
										<li class="dropdown"> 
								...
								<li class="nav-item dropdown">
									<a class="nav-link dropdown-toggle" href="index-7.html#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Pages</a>
									<ul class="dropdown-menu shadow"> 
...
<div class="home-map w-100 vh-100 position-relative">
	<div class="container-fluid h-100">
		<div class="row h-100 align-items-center">
			<div class="offset-lg-6 col-lg-6 col-md-8 offset-md-4">
				<div class="row">
					<form class="adbanced-form-two form-banner amenities-list color-white my-50 px-30 form-on-banner z-index-1">
						<div class="row">
							...
							<div class="form-group col-lg-12 col-md-6">
								<input class="form-control mt-15" type="text" name="address" placeholder="Address, State/City, Zip Code, Location">
							</div>
							<div class="form-group col-lg-4 col-md-6 col-12">
							...
							<div class="form-group mb-0 col-lg-4 col-md-6 col-6">
								<div class="select-wrapper position-relative mt-15">
									<select class="select form-control has-val">
										<option>Baths</option>
										<option>One</option>
							...
							<div class="form-group col-md-6 col-lg-4">
								<input class="btn btn-primary w-100 mt-15" type="submit" name="search" value="Search">
							</div>
							<div class="form-group pt-15 col-md-6 col-lg-4">
								<a class="color-white position-relative plus-minus pl-15 d-block y-center" data-toggle="collapse" href="index-7.html#Collapse1" role="button" aria-expanded="false" aria-controls="Collapse1">Advanced search</a>
							</div>
	...
	<div class="map-home overlay-half-secondery" id="map" style="position: absolute; top: 0; left: 0; bottom: 0; width: 100%"></div>
</div>
<!-- Map End 
==================================================================-->
<!-- New & sale Home Start
			...
			<div class="col-md-12 col-lg-6">
				<div class="row">
					<div class="thumbnail-angle-one overflow-hidden position-relative bg-secondary pt-50 px-50 pb-100 text-center flat-large icon-primary color-white">
						...
						<p>Placerat mi auctor ridiculus sodales mauris cras odio non sociosquse gravida dignissim dictum elementum porta pharetra ultricies cras velit vel sit justo dictum. Pharetra dapibus vehicula amet suscipit arcu, consequat tortor tristique hac dolor. Dictum potenti molestie pellentesque lorem ornare volutpat.</p>
			...
			<div class="col-md-12 col-lg-5 col-xl-6">
		        ...
		        <div class="position-relative">
		        	...
		        	<div class="bg-primary position-absolute color-white" style="display: inline-block; width: 180px; height: auto; padding: 40px 20px; bottom: -35px; left: 50px;">
		        		...
		        		<a class="btn-round mt-20" href="index-7.html#"><i class="fa fa-angle-right"></i></a>
		        	</div>
		        </div>
			</div>
		</div>
						...
						<div class="col-md-12 col-lg-12">
							...
							<div class="position-relative">
								...
								<div class="video-shadow xy-center z-index-1">
									<div class="video">
										<a data-fancybox="" class="video-popup bg-primary color-white" href="https://www.youtube.com/watch?v=8NXLyGiShjs"><i class="fa fa-play" aria-hidden="true"></i></a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-6 col-lg-3">
							<div class="text-thumbnail text-center bg-secondary py-40 px-30 color-white color-white-a box-shadow-gray">
								<a class="mb-20" href="index-7.html#"><h4>Modern Villa</h4></a>
						...
						<div class="col-md-6 col-lg-3">
							<div class="text-thumbnail text-center bg-secondary py-40 px-30 mt-sm-30 color-white color-white-a box-shadow-gray">
								<a class="mb-20" href="index-7.html#"><h4>Family House</h4></a>
								<p class="mb-20">Fames elementum sollicitud pretiuma aenean consequat curabitur hendrerit.</p>
						...
						<div class="col-md-6 col-lg-3">
							<div class="text-thumbnail text-center bg-secondary py-40 px-30 mt-md-30 color-white color-white-a box-shadow-gray">
								<a class="mb-20" href="index-7.html#"><h4>Town House</h4></a>
								<p class="mb-20">Fames elementum sollicitud pretiuma aenean consequat curabitur hendrerit.</p>
						...
						<div class="col-md-6 col-lg-3">
							<div class="text-thumbnail text-center bg-secondary py-40 px-30 mt-md-30 color-white color-white-a box-shadow-gray">
								<a class="mb-20" href="index-7.html#"><h4>Appartment</h4></a>
								<p class="mb-20">Fames elementum sollicitud pretiuma aenean consequat curabitur hendrerit.</p>
								<span class="d-block bg-primary icon-white flat-small"><i class="flaticon-rental"></i></span>
							</div>
						</div>
					...
					<div class="property-item">
						<div class="property-img position-relative overflow-hidden overlay-secondary-4">
							...
							<ul class="hover-option position-absolute icon-white z-index-1">
								<li>
									<a data-toggle="tooltip" data-placement="top" title="Wishlist" href="index-7.html#"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
								</li>
								<li>
									<a data-toggle="tooltip" data-placement="top" title="Compare" href="index-7.html#"><i class="fa fa-random" aria-hidden="true"></i></a>
								</li>
							</ul>
				...
				<div class="row">
						...
						<div class="agencies mt-30 py-40 px-30 bg-gray hover-secondery-primary">
							<div class="row">
								<div class="col-md-12 col-lg-12 col-xl-4 d-flex align-items-center">
									<a href="index-7.html#"><img src="{{_var.base}}/images/partner/1.png" alt="image"></a>
								</div>
								<div class="col-md-12 col-lg-12 col-xl-8">
									<div class="agencies-content">
										<a href="index-7.html#"><h4>Homelax Builders</h4></a>
					...
					<div class="col-md-12 col-lg-6">
						<div class="agencies mt-30 py-40 px-30 bg-gray hover-secondery-primary">
							<div class="row">
								<div class="col-md-12 col-lg-12 col-xl-4 d-flex align-items-center">
									<a href="index-7.html#"><img src="{{_var.base}}/images/partner/2.png" alt="image"></a>
								</div>
								<div class="col-md-12 col-lg-12 col-xl-8">
									<div class="agencies-content">
										<a href="index-7.html#"><h4>Landex Builders</h4></a>
					...
					<div class="col-md-12 col-lg-6">
						<div class="agencies mt-30 py-40 px-30 bg-gray hover-secondery-primary">
							<div class="row">
								<div class="col-md-12 col-lg-12 col-xl-4 d-flex align-items-center">
									<a href="index-7.html#"><img src="{{_var.base}}/images/partner/3.png" alt="image"></a>
								</div>
								<div class="col-md-12 col-lg-12 col-xl-8">
									<div class="agencies-content">
										<a href="index-7.html#"><h4>Nester Builders</h4></a>
					...
					<div class="col-md-12 col-lg-6">
						<div class="agencies mt-30 py-40 px-30 bg-gray hover-secondery-primary">
							<div class="row">
								<div class="col-md-12 col-lg-12 col-xl-4 d-flex align-items-center">
									<a href="index-7.html#"><img src="{{_var.base}}/images/partner/4.png" alt="image"></a>
								</div>
								<div class="col-md-12 col-lg-12 col-xl-8">
									<div class="agencies-content">
										<a href="index-7.html#"><h4>Realhome Builders</h4></a>
										<span class="mt-5 mb-30 d-block">11-13 Whitehall, London SW1A 2DD, UK</span>
										<ul>
											<li>
												<div class="position-relative bg-secondary color-white py-5 px-10 d-inline-block">
				...
				<div class="owl-carousel slide-2 mt-30">
					<div class="feedback-item p-30 bg-secondary color-white">
						<div class="feedback-details">
							<p>Massa sapien nunc justo sem turpis nonummy Ullamcorpe suscipit ad auctor magnis ante eu aptent id sociis. Cursus volutpat faucibus litora Dolor sollicitudin orci praesent penatibus.</p>
						</div>
		...
		<div class="row">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="gallery-img overflow-hidden position-relative mt-30 overlay-secondary">
							...
							<div class="cities-info">
								<h5><a class="color-white" href="index-7.html#">New York</a></h5>
					...
					<div class="col-lg-12">
						<div class="gallery-img overflow-hidden position-relative mt-30 overlay-secondary">
							...
							<div class="cities-info">
								<h5><a class="color-white" href="index-7.html#">Las Vegas</a></h5>
			...
			<div class="col-lg-5">
				<div class="gallery-img overflow-hidden position-relative mt-30 overlay-secondary">
					...
					<div class="cities-info">
						<h5><a class="color-white" href="index-7.html#">San Francisco</a></h5>
				...
				<div class="gallery-img overflow-hidden position-relative mt-30 overlay-secondary">
					...
					<div class="cities-info">
						<h5><a class="color-white" href="index-7.html#">California</a></h5>
			...
			<div class="col-lg-3">
				<div class="gallery-img overflow-hidden position-relative mt-30 overlay-secondary">
					...
					<div class="cities-info">
						<h5><a class="color-white" href="index-7.html#">Melbourne</a></h5>
						<span class="color-gray-light mt-5 d-inline-block">20+ Properties</span>
					</div>
				</div>
				<div class="gallery-img overflow-hidden position-relative mt-30 overlay-secondary">
					...
					<div class="cities-info">
						<h5><a class="color-white" href="index-7.html#">Moscow</a></h5>
			...
			<div class="col-md-12 col-lg-12">
				...
				<div id="slider" style="height:330px;margin:0 auto;">
					...
					<div class="ls-slide" data-ls="duration:4000; transition2d:1; kenburnsscale:1.2;">
						...
						<img width="491" height="300" src="{{_var.base}}/images/property/20.jpg" class="ls-l" alt="" style="top:30px; left:0px;" data-ls="offsetxin:80; offsetxout:-80; durationout:400; parallaxlevel:0;">
						...
						<p style='font-family:"Roboto"; font-size:18px; font-weight: 500; color:#fd9834; top:78px; left:555px;' class="ls-l" data-ls="offsetxin:20; delayin:1600; easingin:easeOutQuint; offsetxout:-80; durationout:400; parallaxlevel:0;">$ 12000</p>
					...
					<div class="ls-slide" data-ls="duration:4000; transition2d:1; kenburnsscale:1.2;">
						<p style=" box-shadow: 0px 4px 2px -3px rgba(0,0,0,0.4);width:940px; height:300px; background:#f5f5f5; top:30px; left:0px;" class="ls-l" data-ls="offsetxin:80; offsetxout:-80; durationout:400; parallaxlevel:0;"></p>
						<img width="491" height="300" src="{{_var.base}}/images/property/21.jpg" class="ls-l" alt="" style="top:30px; left:450px;" data-ls="offsetxin:80; offsetxout:-80; durationout:400; parallaxlevel:0;">
						...
						<p style='font-family:"Roboto"; font-size:18px; font-weight: 500; color:#fd9834; top:78px; left:55px;' class="ls-l" data-ls="offsetxin:20; delayin:1600; easingin:easeOutQuint; offsetxout:-80; durationout:400; parallaxlevel:0;">$ 15000</p>
					...
					<div class="ls-slide" data-ls="duration:4000; transition2d:1; kenburnsscale:1.2;">
						<p style=" box-shadow: 0px 4px 2px -3px rgba(0,0,0,0.4);width:940px; height:300px; background:#f5f5f5; top:30px; left:0px;" class="ls-l" data-ls="offsetxin:80; offsetxout:-80; durationout:400; parallaxlevel:0;"></p>
						<img width="491" height="300" src="{{_var.base}}/images/property/22.jpg" class="ls-l" alt="" style="top:30px; left:0px;" data-ls="offsetxin:80; offsetxout:-80; durationout:400; parallaxlevel:0;">
						<div style="width:50px; height:50px; top:144px; left:466px;" class="ls-l" data-ls="delayin:500; rotatein:90; scalexin:0.5; scaleyin:0.5; transformoriginin:50% 50% 50%; offsetxout:-80; durationout:0; rotateout:-90; parallaxlevel:0;">
							<div style="-webkit-transform: rotate(45deg); transform: rotate(45deg); background:#242424; width:100%;height:100%;"></div>
						</div>
						<p style='font-family:"Roboto"; font-size:18px; font-weight: 500; color:#fd9834; top:78px; left:555px;' class="ls-l" data-ls="offsetxin:20; delayin:1600; easingin:easeOutQuint; offsetxout:-80; durationout:400; parallaxlevel:0;">$ 50000</p>
						<p style='font-family:"Montserrat"; font-size:24px; font-weight: 600; color:#242424; top:111px; left:555px;' class="ls-l" data-ls="offsetxin:20; delayin:1600; easingin:easeOutQuint; offsetxout:-80; durationout:400; parallaxlevel:0;">Park Avanue Apartment</p>
						<p style='font-family:"Roboto"; font-size:14px; font-weight: 400; color:#666666; top:151px; left:555px;' class="ls-l" data-ls="offsetxin:20; delayin:1600; easingin:easeOutQuint; offsetxout:-80; durationout:400; parallaxlevel:0;"><span class="icon-primary f-14 mr-5"><i class="fa fa-map-marker"></i></span> 11-13 Whitehall, London SW1A 2DD, UK</p>
						<div style='font-weight:300; text-align:justify;width:320px; font-family:"Roboto"; font-size:16px; color:#595959; top:190px; left:555px; white-space:normal;' class="ls-l" data-ls="offsetxin:20; delayin:1700; easingin:easeOutQuint; offsetxout:-80; durationout:400; parallaxlevel:0;">
							<ul class="property-hot-slider-icon icon-primary">
					...
					<div class="ls-slide" data-ls="duration:4000; transition2d:1; kenburnsscale:1.2;">
						<p style=" box-shadow: 0px 4px 2px -3px rgba(0,0,0,0.4);width:940px; height:300px; background:#f5f5f5; top:30px; left:0px;" class="ls-l" data-ls="offsetxin:80; offsetxout:-80; durationout:400; parallaxlevel:0;"></p>
						<img width="491" height="300" src="{{_var.base}}/images/property/23.jpg" class="ls-l" alt="" style="top:30px; left:450px;" data-ls="offsetxin:80; offsetxout:-80; durationout:400; parallaxlevel:0;">
						<div style="width:50px; height:50px; top:145px; left:425px;" class="ls-l" data-ls="delayin:500; rotatein:90; scalexin:0.5; scaleyin:0.5; transformoriginin:50% 50% 50%; offsetxout:-80; durationout:0; rotateout:-90; parallaxlevel:0;">
							<div style="-webkit-transform: rotate(45deg); transform: rotate(45deg); background:#000; width:100%;height:100%;"></div>
						</div>
						<p style='font-family:"Roboto"; font-size:18px; font-weight: 500; color:#fd9834; top:78px; left:55px;' class="ls-l" data-ls="offsetxin:20; delayin:1600; easingin:easeOutQuint; offsetxout:-80; durationout:400; parallaxlevel:0;">$ 75000</p>
						<p style='font-family:"Montserrat"; font-size:24px; font-weight: 600; color:#242424; top:111px; left:55px;' class="ls-l" data-ls="offsetxin:20; delayin:1600; easingin:easeOutQuint; offsetxout:-80; durationout:400; parallaxlevel:0;">Villa on Grand Avenue</p>
						<p style='font-family:"Roboto"; font-size:14px; font-weight: 400; color:#666666; top:151px; left:55px;' class="ls-l" data-ls="offsetxin:20; delayin:1600; easingin:easeOutQuint; offsetxout:-80; durationout:400; parallaxlevel:0;"><span class="icon-primary f-14 mr-5"><i class="fa fa-map-marker"></i></span> 40 Tower Avenue, Melbourne, Australia.</p>
						<div style='font-weight:300; text-align:justify;width:320px; font-family:"Roboto"; font-size:16px; color:#595959; top:190px; left:55px; white-space:normal;' class="ls-l" data-ls="offsetxin:20; delayin:1700; easingin:easeOutQuint; offsetxout:-80; durationout:400; parallaxlevel:0;">
							<ul class="property-hot-slider-icon icon-primary">
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-4 col-md-4 col-lg-6">
				<div class="footer-logo"><a href="index-7.html#"><img src="{{_var.base}}/images/logo/logo-white.png" alt="Footer Logo"></a></div>
			</div>
