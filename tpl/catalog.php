...
=========================================================================-->
    ...
    <div class="page-banner overlay-black"
        style="padding: 150px 0; background-image:url(/thumb/1920x400/src{{images.0.img}});">
            ...
            <div class="row">
                            ...
                            <div class="col-12">
                                <ul class="nav nav-tabs border-0 navbar-tab-view mt-sm-15" id="myTab" role="tablist"
                                    ...
                                    <li class="nav-item w-50">
                                        <a class="nav-link ___active" id="home-tab" data-toggle="tab" href="#home"
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="tab-content  border-top-1-gray" id="myTabContent">
                        <div class="tab-pane fade ___show ___active" id="home" role="tabpanel"
                                                ...
                                                <div class="price_range">
                                                    <div class="price-filter" wb-data="table=admin&item=complex_data">
                                                        <wb-data wb='table=admin&item=complex_data'>
                                                            <span>
                                                                <input class="filter_range" type="text"
                                                                    name="square__minmax" dimension="&nbsp;кв.м"
                                                                    value="{{square_min}}; {{square_max}}" />
                                                            </span>
                                                        </wb-data>
                                                    </div>
                                                </div>
                            ...
                            <div class="row" id="catalogList">
                                <wb-foreach wb='table=objects&size={{_sett.page_size}}&sort=name&bind=site.catalogList'
                                    ...
                                    <wb-empty>
                                        <div class="col-12">
                                            <div class="alert alert-info w-100 my-20 p-20">К сожалению, по выбранным
                                                критериям ничего не найдено.</div>
                                        </div>
                                    </wb-empty>
                                </wb-foreach>
                            </div>
                                        ...
                                        <div class="row  pb-40">
                                            <div class="form-group col-lg-4 col-md-6 col-12 pt-15">
                                                <div class="select-wrapper position-relative">
                                                    <select
                                                        wb-tree="item=city&branch=districts&parent=false&children=false&sort=name"
                                                        wb-change="#apartFilter [name=metro],#apartFilter [name=object]"
                                            ...
                                            <div class="form-group col-lg-4 col-md-6 col-6 pt-15">
                                                <div class="select-wrapper position-relative">
                                                    <select
                                                        wb-tree="item=city&branch=districts->%district%&parent=false&children=false&sort=name"
                                                        wb-strict="false" placeholder="Метро..."
                                                        wb-change="#apartFilter [name=object]" name="metro"
                                                        class="form-control has-val">
                                                        <option value="{{id}}" data-metro="{{id}}"
                                                            data-district='%district%'>{{name}}
                                                        </option>
                                            ...
                                            <div class="form-group col-lg-4 col-md-6 col-6 pt-15">
                                                <div class="select-wrapper position-relative">
                                                    <select wb-change="#apartFilter [name=building]" name="object"
                                                        class="form-control has-val" placeholder="Комплекс...">
                                                        <wb-foreach wb="table=objects"
                                                            wb-filter='{"district":"%district%","metro":"%metro%","active":"on"}'
                                                            wb-strict="false">
                                            ...
                                            <div class="form-group col-lg-4 col-md-6 col-6 pt-15">
                                                <div class="select-wrapper position-relative">
                                                    <select wb-tree="form=objects&item=%value%&field=buildings"
                                                        name="building" class="form-control" placeholder="Корпус...">
                                            ...
                                            <div class="form-group col-lg-4 col-md-6 col-6 pt-15">
                                                <div class="select-wrapper position-relative">
                                                    <select wb-tree="item=types&branch=units&parent=false" placeholder="Тип..." name="type"
                                                        class="form-control">
                                                        <option value="{{id}}">{{name}}</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="price_range">
                                                    <div class="price-filter" wb-data="table=admin&item=complex_data">
                                                        <wb-data wb='table=admin&item=complex_data'>
                                                            <span>
                                                                <input class="filter_range" type="text"
                                                                    name="square__range" dimension="&nbsp;кв.м"
                                                                    value="{{square_min}}; {{square_max}}" />
                                                            </span>
                                                        </wb-data>
                                                    </div>
                                    ...
                                    <div class="col-md-12 col-lg-6 col-xl-4">
                                        <div class="property-thumbnail mt-30">
                                            <div
                                                ...
                                                <div class="thumbnail-content z-index-1 color-white-a color-white">
                                                    <span
                                                        class="thum-category category-1 bg-secondary color-white z-index-1 px-15">
                                                        {{square}} кв.м.
                                                    ...
                                                    <a class="color-secondary mb-5"
                                                        ...
                                                        <div class="hover-content py-30 px-20 overlay-hover-gradient">
                                                            ...
                                                            <ul
                                                                ...
                                                                <li class="text-truncate"
                                                                    wb-tree="item=city&branch={{metro}}&children=false">
                                                                    <i class="fa fa-subway" aria-hidden="true"></i>
                                                                    <nobr>{{name}}</nobr>
                                                                </li>
                                                            </ul>
