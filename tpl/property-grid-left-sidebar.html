			...
			<div class="row">
				...
				<div class="col-md-12 col-lg-3 col-xl-4">
					<ul class="social-media-1 d-flex color-white-a float-right">
						<li><a href="property-grid-left-sidebar.html#"><i class="fa fa-facebook"></i></a></li>
						<li><a href="property-grid-left-sidebar.html#"><i class="fa fa-twitter"></i></a></li>
						<li><a href="property-grid-left-sidebar.html#"><i class="fa fa-behance"></i></a></li>
						<li><a href="property-grid-left-sidebar.html#"><i class="fa fa-instagram"></i></a></li>
						<li><a href="property-grid-left-sidebar.html#"><i class="fa fa-linkedin"></i></a></li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<nav class="navbar navbar-expand-lg navbar-light px-0">
						<a class="navbar-brand" href="property-grid-left-sidebar.html#"><img src="images/logo/logo-white.png" alt="logo"></a>
							...
							<ul class="navbar-nav mx-auto">
								<li class="nav-item dropdown">
									...
									<ul class="dropdown-menu"> 
										...
										<li><a class="dropdown-item" href="index-16.html">Home Sixteen</a></li>									</ul>
								</li>
								<li class="nav-item dropdown">
									<a class="nav-link dropdown-toggle" href="property-grid-left-sidebar.html#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Listing</a>
									<ul class="dropdown-menu shadow">
										<li class="dropdown"> 
											<a class="dropdown-toggle dropdown-item" href="property-grid-left-sidebar.html#">Property</a>
											<ul class="dropdown-menu shadow">
										...
										<li class="dropdown"> 
											<a class="dropdown-toggle dropdown-item" href="property-grid-left-sidebar.html#">Booking Page</a>
											<ul class="dropdown-menu shadow">
								...
								<li class="nav-item dropdown">
									<a class="nav-link dropdown-toggle" href="property-grid-left-sidebar.html#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Agents</a>
									<ul class="dropdown-menu shadow">
										<li class="dropdown"> 
											<a class="dropdown-toggle dropdown-item" href="property-grid-left-sidebar.html#">Agents</a>
											<ul class="dropdown-menu shadow">
										...
										<li class="dropdown"> 
											<a class="dropdown-toggle dropdown-item" href="property-grid-left-sidebar.html#">Agency</a>
											<ul class="dropdown-menu shadow">
								...
								<li class="nav-item dropdown">
									<a class="nav-link dropdown-toggle" href="property-grid-left-sidebar.html#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Pages</a>
									<ul class="dropdown-menu shadow"> 
										...
										<li class="dropdown"> 
											<a class="dropdown-toggle dropdown-item" href="property-grid-left-sidebar.html#">Blog</a>
											<ul class="dropdown-menu shadow">
			...
			<div class="col-md-12 col-lg-12">
				<nav aria-label="breadcrumb">
				  <ol class="breadcrumb m-0 py-15 px-0 bg-transparent hover-white-primary">
				    <li class="breadcrumb-item"><a href="property-grid-left-sidebar.html#">Home</a></li>
				    <li class="breadcrumb-item"><a href="property-grid-left-sidebar.html#">Listing</a></li>
				    <li class="breadcrumb-item"><a href="property-grid-left-sidebar.html#">Property</a></li>
				    <li class="breadcrumb-item active" aria-current="page">Property Grid Left Sidebar</li>
				  </ol>
				</nav>
			</div>
		</div>
	...
	<div class="container">
		<div class="row">
							...
							<div class="row">
								...
								<div class="col-md-4 col-lg-5">
									<ul class="nav nav-tabs border-0 float-right navbar-tab-view mt-sm-15" id="myTab" role="tablist" style="line-height: 20px;">
								  		<li class="nav-item">
									    	<a class="nav-link active" id="home-tab" data-toggle="tab" href="property-grid-left-sidebar.html#home" role="tab" aria-controls="home" aria-selected="true"><i class="fa fa-th-large" aria-hidden="true"></i></a>
									  	</li>
									  	<li class="nav-item">
										    <a class="nav-link" id="contact-tab" data-toggle="tab" href="property-grid-left-sidebar.html#contact" role="tab" aria-controls="contact" aria-selected="false"><i class="fa fa-th" aria-hidden="true"></i></a>
									  	</li>
									  	<li class="nav-item">
									    	<a class="nav-link" id="profile-tab" data-toggle="tab" href="property-grid-left-sidebar.html#profile" role="tab" aria-controls="profile" aria-selected="false"><i class="fa fa-list" aria-hidden="true"></i></a>
									  	</li>
									</ul>
								</div>
							</div>
			...
			<div class="col-md-12 col-lg-4">
				<form class="adbanced-form-two amenities-list bg-white py-40 px-30 mt-30">
	  				<div class="row">
						...
						<div class="form-group mb-50 pb-15 col-lg-12">
						...
						<div class="form-group col-lg-12 pt-15 mb-0">
							<label>Amenities</label>
							<ul class="list-bottom select-option">
								<li>
			  					...
			  					<div class="property-item position-relative mt-30">
									<div class="property-img position-relative overflow-hidden overlay-secondary-4">
										...
										<ul class="hover-option position-absolute icon-white z-index-1">
											<li>
												<a data-toggle="tooltip" data-placement="top" title="Wishlist" href="property-grid-left-sidebar.html#"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
											</li>
											<li>
												<a data-toggle="tooltip" data-placement="top" title="Compare" href="property-grid-left-sidebar.html#"><i class="fa fa-random" aria-hidden="true"></i></a>
											</li>
										</ul>
			  				...
			  				<div class="col-lg-12">
								<div class="mx-auto d-table">
									<ul class="pagination mt-50">
										<li class="page-item"><a class="page-link" href="property-grid-left-sidebar.html#">Prev</a></li>
										<li class="page-item"><a class="page-link active" href="property-grid-left-sidebar.html#">1</a></li>
										<li class="page-item"><a class="page-link" href="property-grid-left-sidebar.html#">2</a></li>
										<li class="page-item"><a class="page-link" href="property-grid-left-sidebar.html#">3</a></li>
										<li class="page-item"><a class="page-link" href="property-grid-left-sidebar.html#">Next</a></li>
									</ul>
								</div>
							</div>
			  			</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-4 col-md-4 col-lg-6">
				<div class="footer-logo"><a href="property-grid-left-sidebar.html#"><img src="images/logo/logo-white.png" alt="Footer Logo"></a></div>
			</div>
				...
				<div class="footer-widget color-gray-light mt-sm-30">
					...
					<div class="widget-content hover-white-primary">
						<ul class="quick-links">
							<li><a href="property-grid-left-sidebar.html#">Company</a></li>
							<li><a href="property-grid-left-sidebar.html#">Community</a></li>
							<li><a href="property-grid-left-sidebar.html#">Carrers</a></li>
							<li><a href="property-grid-left-sidebar.html#">News</a></li>
							<li><a href="property-grid-left-sidebar.html#">Contact</a></li>
						</ul>
					</div>
				</div>
			</div>
			<div class="col-sm-6 col-md-6 col-lg-3">
				<div class="footer-widget color-gray-light mt-md-30">
					...
					<div class="widget-content hover-white-primary">
						<ul class="quick-links">
							<li><a href="property-grid-left-sidebar.html#">For Rent</a></li>
							<li><a href="property-grid-left-sidebar.html#">For Sale</a></li>
							<li><a href="property-grid-left-sidebar.html#">Commercial</a></li>
							<li><a href="property-grid-left-sidebar.html#">Agents</a></li>
							<li><a href="property-grid-left-sidebar.html#">Property Guides</a></li>
						</ul>
					</div>
				</div>
			</div>
			<div class="col-sm-6 col-md-6 col-lg-3">
				<div class="footer-widget color-gray-light mt-sm-30">
					...
					<div class="widget-content hover-white-primary">
						<ul class="quick-links">
							<li><a href="property-grid-left-sidebar.html#">Payments</a></li>
							<li><a href="property-grid-left-sidebar.html#">Shipping</a></li>
							<li><a href="property-grid-left-sidebar.html#">Cancellation</a></li>
							<li><a href="property-grid-left-sidebar.html#">FAQ</a></li>
							<li><a href="property-grid-left-sidebar.html#">Report</a></li>
						</ul>
					</div>
				</div>
			</div>
