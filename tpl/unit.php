...
=========================================================================-->
	...
	<div class="page-banner overlay-white" style="padding: 20px 0; background-image:url(/thumb/192x40/src{{images.0.img}});">
						...
						<div class="row">
							<div class="col-md-12 col-lg-8">
								<div class="single-property position-relative">
									<span class="bg-secondary color-white z-index-1 px-15 py-5 mr-20" wb-tree="item=types&branch=units->{{type}}&children=false">
										<wb>{{name}}</wb>
									</span>
					...
					<div class="sidebar-widget bg-white mt-50 shadow py-40 px-30">
						...
						<div class="d-flex">
							<div class="contact-agent-image mr-20 float-left">
								<img data-src="images/team/1.jpg" class="rounded-circle" alt="images">
							</div>
						...
						<div class="owl-carousel slide-1 owl-dots-none">
							<div class="property-item">
								<div class="property-img position-relative overflow-hidden overlay-secondary-4">
									...
									<ul class="hover-option position-absolute icon-white z-index-1">
										<li>
											<a data-toggle="tooltip" data-placement="top" title="Wishlist" href="single-property.html#">
												<i class="fa fa-heart-o" aria-hidden="true"></i>
											</a>
										</li>
										<li>
											<a data-toggle="tooltip" data-placement="top" title="Compare" href="single-property.html#">
												<i class="fa fa-random" aria-hidden="true"></i>
											</a>
										</li>
									</ul>
							...
							<div class="property-item">
								...
								<div class="property-content bg-white pt-30 pb-50">
									...
									<span class="address icon-primary f-14">
										<i class="fa fa-map-marker"></i>11-13 Whitehall, London, UK</span>
									<ul class="about-property list-half icon-primary d-table f-14 mb-30 mt-20">
										<li>
											<i class="flaticon-fit-screen"></i>200 sqft</li>
										<li>
